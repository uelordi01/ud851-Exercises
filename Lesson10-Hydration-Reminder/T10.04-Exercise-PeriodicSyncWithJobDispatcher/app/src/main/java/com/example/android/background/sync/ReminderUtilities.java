...
public class ReminderUtilities {
        ...
        private final static int REMINDER_INTERVAL_SECONDS = (int) java.util.concurrent.TimeUnit.MINUTES.toSeconds(REMINDER_INTERVAL_MINUTES);
        private final static int SYNC_FLEXTIME_SECONDS = REMINDER_INTERVAL_SECONDS;
        private final static String REMINDER_JOB_TAG = "HydrationReminderTag";
