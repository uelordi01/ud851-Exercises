...
public class ReminderTasks {
    ...
    public static final String ACTION_ISSUE_CHARGING = "issue-charging";
    ...
    public static void executeTask(Context context, String action) {
        ...
        else if(ACTION_ISSUE_CHARGING.equals(action)) {
            // todo my things to call to the specific method.
